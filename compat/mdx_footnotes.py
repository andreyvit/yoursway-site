...
class FootnoteExtension (markdown.Extension):
    ...
    def makeFootnotesDiv (self, doc) :
        ...
        for i, id in footnotes :
            fn = doc.createElement('div')
            fn.setAttribute('class', 'footnote')
            fn.setAttribute('id', self.makeFootnoteId(i))
            ...
            backlink.appendChild(doc.createTextNode(str(i)))

            num = doc.createElement('sup')
            num.appendChild(backlink)

            fn.appendChild(num)

            fn.appendChild(doc.createTextNode(' - '))
            
            self.md._processSection(fn, self.footnotes[id].split("\n"))
